...
-- AddForeignKey
ALTER TABLE `ShopDetails` ADD CONSTRAINT `ShopDetails_addressId_fkey` FOREIGN KEY (`addressId`) REFERENCES `Address`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `ShopDetails` ADD CONSTRAINT `ShopDetails_shopId_fkey` FOREIGN KEY (`shopId`) REFERENCES `Shop`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `ShopDetails` ADD CONSTRAINT `ShopDetails_shopUrlId_fkey` FOREIGN KEY (`shopUrlId`) REFERENCES `ShopUrl`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
